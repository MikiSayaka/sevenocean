...
router.post('/', function(req, res, next) {
  ...
  if (_startDate != undefined && _endDate != undefined) {
    ...
    try {
      ...
      _containerInfo.carrier_type = (req.body.carrier_type == undefined) ? '' : req.body.carrier_type;
      _containerInfo.discharge_port = (req.body.discharge_port == undefined) ? '' : req.body.discharge_port;
      _containerInfo.carrier_id = (req.body.carrier_id == undefined) ? '' : req.body.carrier_id;
      _containerInfo.acceptance_ref = (req.body.acceptance_ref == undefined) ? '' : req.body.acceptance_ref;
